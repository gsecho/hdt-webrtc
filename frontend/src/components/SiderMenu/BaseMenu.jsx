...
const getIcon = icon => {
  if (typeof icon === 'string' && (isUrl(icon) || icon.startsWith("data"))) {
    return <img src={icon} alt="icon" className={`${styles.icon} anticon`} />;
  }
...
export default class BaseMenu extends PureComponent {
  ...
  render() {
    ...
    if (collapsed) {
      ...
      menuStyle.paddingLeft = '12px';
      menuStyle.paddingRight = '4px';
    }
